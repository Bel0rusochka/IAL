...
If the path is not specified, the default path is selected like "./grafs/graf_1.txt".
...
int main(int argc, char *argv[]){
    ...
    //Alocating memory for the graph
    graf_item graf;
    init_graf(&graf);

    /*
    Alocating memory for the array of nodes. At the end of the program, 
